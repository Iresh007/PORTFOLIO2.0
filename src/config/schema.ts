...
/**
 * Schema for Certifications section configuration.
 */
export const CertificationsSectionSchema = z.object({
  eyebrow: z.string().default('Credentials'),
  headline: z.string().default('Certifications'),
  description: z.string().optional(),
})
...
export const ContentConfigSchema = z.object({
  ...
  certificationsSection: CertificationsSectionSchema.optional(),
