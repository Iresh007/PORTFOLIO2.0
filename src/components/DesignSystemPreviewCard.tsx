...
> = {
  ...
  pipeline: {
    label: 'Pipeline',
    description: 'Data console & schema-driven',
  },
}

function CorporatePreview() {
  return (
    <div className="w-full h-16 relative overflow-hidden rounded-lg bg-gradient-to-br from-slate-100 to-background">
      {/* Navy header bar */}
      <div className="absolute top-0 left-0 right-0 h-3 bg-muted" />
      {/* Content blocks */}
...
function PipelinePreview() {
  return (
    ...
    >
      {/* schema label bar, like a table/object name */}
      <div className="absolute top-2 left-2 right-2 flex items-center gap-1.5">
        ...
        />
        <div
          className="h-1.5 flex-1 max-w-[60%] rounded-sm"
          style={{ background: '#232b38' }}
        />
      </div>
      {/* monospace-style content rows */}
      <div className="absolute top-7 left-2 right-2 space-y-1.5">
        ...
        <div className="flex items-center gap-1">
          ...
          />
          <div
            className="h-1 flex-1 max-w-[70%] rounded-sm"
            style={{ background: '#1a2129' }}
          />
        </div>
      </div>
      {/* thin gutter rule, like a code block left edge */}
      <div
  ...
  return (
    ...
    >
      ...
      <div className="mb-2 overflow-hidden rounded-button">
        ...
        {designSystem === 'pipeline' && <PipelinePreview />}
      </div>
