...
export function Skills() {
  ...
  return (
    <section id="skills" ref={pipelineRef} className="relative overflow-hidden section-padding">
      ...
      <div className="container-wide">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-muted dark:bg-muted flex items-center justify-center">
                      <Icon className="w-5 h-5 text-foreground dark:text-slate-400" />
                    </div>
                    <CardTitle className="text-base font-semibold text-foreground text-foreground">
                      {category.name}
                    </CardTitle>
                  </div>
                </CardHeader>
        ...
        {skillsSummary.length > 0 && (
          <Card
            className={cn(
              'mt-12 max-w-3xl mx-auto border-navy-800 dark:border-navy-600 bg-gradient-to-br from-navy-900 to-background text-white',
              isVisible && 'animate-fade-in-up'
            )}
