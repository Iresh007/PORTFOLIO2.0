...
import { LockDesignDefault } from '@/components/LockDesignDefault'
...
export function ThemeChooserPanel({ isOpen, onClose }: ThemeChooserPanelProps) {
  ...
  // Cleanup close-animation timer on unmount (SEC-005 timer leak fix)
  useEffect(() => {
    return () => {
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          ...
          <section>
            ...
            {isOwner && (
              <div className="mt-3">
                <LockDesignDefault designSystem={designSystem} />
              </div>
            )}
          </section>
        ...
        <div className="p-4 border-t border-border">
          <p className="text-xs text-muted-foreground text-center">
            Your choices here are saved on this device only. New visitors
            see the site's default design.
          </p>
        </div>
      </div>
    </div>
